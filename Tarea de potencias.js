function ejecuta(){
	...
	if (x.length==0){
		alert("Error, se debe indicar el valor inicial");
		...
		if ((x<=0)||(x>=11)) {
			...
			if (y.length==0){
				alert("Error, se debe indicar el segundo valor");
...
function campo_v1(){
	document.f_ciclos.x.style.background="yellow";
}
function campo_v2(){
	document.f_ciclos.y.style.background="yellow";
}